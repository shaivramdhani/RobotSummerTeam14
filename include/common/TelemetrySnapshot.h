...
struct TelemetrySnapshot {
  ...
  float habitat_pieces_compensation_strafe_duty{0.0F};
  Milliseconds habitat_pieces_compensation_strafe_duration_ms{0U};
  Milliseconds habitat_pieces_compensation_strafe_elapsed_ms{0U};
  Milliseconds habitat_pieces_compensation_strafe_remaining_ms{0U};
  ...
  Milliseconds habitat_pieces_slide_down_remaining_ms{0U};
  float habitat_pieces_forward_to_distance_duty{0.0F};
  std::uint16_t habitat_pieces_forward_stop_distance_mm{0U};
  Milliseconds habitat_pieces_forward_to_distance_timeout_ms{0U};
  Milliseconds habitat_pieces_forward_to_distance_elapsed_ms{0U};
  Milliseconds habitat_pieces_forward_to_distance_remaining_ms{0U};
  std::uint32_t habitat_pieces_slide_lift_steps{0U};
  std::uint32_t habitat_pieces_slide_lift_speed_steps_per_second{0U};
  Milliseconds habitat_pieces_slide_lift_timeout_ms{0U};
  Milliseconds habitat_pieces_slide_lift_elapsed_ms{0U};
  Milliseconds habitat_pieces_slide_lift_remaining_ms{0U};
  ...
  Milliseconds habitat_pieces_post_pickup_reverse_remaining_ms{0U};
  float habitat_pieces_return_strafe_duty{0.0F};
  Milliseconds habitat_pieces_return_line_timeout_ms{0U};
  Milliseconds habitat_pieces_return_strafe_elapsed_ms{0U};
  Milliseconds habitat_pieces_return_strafe_remaining_ms{0U};
  ...
  bool habitat_pieces_compensation_strafing{false};
  bool habitat_pieces_lowering_slide{false};
  bool habitat_pieces_slide_bottom_ready{false};
  bool habitat_pieces_forward_to_distance{false};
  bool habitat_pieces_forward_distance_reached{false};
  bool habitat_pieces_slide_lift_started{false};
  bool habitat_pieces_slide_lift_complete{false};
  bool habitat_pieces_post_pickup_reversing{false};
  bool habitat_pieces_return_line_strafing{false};
  bool habitat_pieces_waiting_for_slide_lift{false};
  bool habitat_pieces_rear_line_configured{false};
  bool habitat_pieces_rear_line_data_fresh{false};
  bool habitat_pieces_rear_left_black{false};
  bool habitat_pieces_rear_right_black{false};
